...
private: 
    ...
    void markup_inside_brackets( Positions_Map::Iterator& iter_left_bracket );
    void form_table();
    void register_state( const Int_Set& state );
    Positions_Map::Iterator seek_right_bracket( Positions_Map::Iterator& iter_left_bracket );
    bool is_inside_nested_brackets( Positions_Map::Iterator& iter_left_outer_bracket,
        Positions_Map::Iterator& iter_position );
